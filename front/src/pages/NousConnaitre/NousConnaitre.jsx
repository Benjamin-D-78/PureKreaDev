            ...
            <div className={commande.conteneurGlobal}>
                ...
                <div className={boutique.conteneurDH}>
                    ...
                    <div className={nous_connaitre.accordeon}>
                        ...
                        {ouvrirB && (
                            <div className={nous_connaitre.corpsAccordeon}>
                                <p className={nous_connaitre.pAccordeon}>{<>La cravate est l'accessoire qui accompagne le plus ma garde-robe. J'en suis moi-même un friand collectionneur. <br /><br /> Qui n'a pas déjà entendu ce bon vieux malentendu qui est de penser que la cravate est le symbole de la laisse autours du cou ? <br /><br /> Rien n'est plus faux. <br /><br /> Si l'on fait le point : en dehors de la qualité des tissus, un homme n'a que peu de choix possibles pour habiller sa tenue. Nous optons pour les bagues, les boutons de manchettes, des petits mouchoirs de poche, et puis c'est à peu près tout. <br /><br /> La cravate, victime de ses préjugés et pourtant bel et bien un inconditionnel de l'élégance masculine, est la fois l'accessoire le plus voyant. <br /><br /> Quitte à créer quelque chose qui ait du sens, autant que ce soit la cravate.</>}</p>
                            </div>
                        )}
                        ...
                        {ouvrirD && (
                            <div className={nous_connaitre.corpsAccordeon}>
                                <p className={nous_connaitre.pAccordeon}>{<>Pour PureKréa, l'avenir de la cravate a le même destin que toute pièce vestimentaire : il fluctuera selon les aléas de la mode. <br /><br /> La cravate a traveré les siècles et, bien qu'elle ait connu des périodes de déclin, elle reste un accessoire symbolique dans de nombreux environnements professionnels, sociaux et cérémoniaux. <br /><br /> Alors que tout le confort moderne et accessible tend à nous faire penser que certains accessoires vestimentaires viendraient à disparaître (comme les boutons de manchettes par exemple), toutes les statistiques venant des entreprises de markéting mettent en avant un vrai goût pour l'art tailleur de la part des jeunes. <br /><br /> Pour PureKréa, c'est bien la preuve que les modes vestimentaires ne cessent de fluctuer et que nos jeunes ont soif de singularité !</>}</p>
                            </div>
                        )}
                    </div>
